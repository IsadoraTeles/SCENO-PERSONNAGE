...
Agent ReadAgent(ivec2 coord)
{
    ...
    a.maxSpeed = Map(a.DNA.b, 0, 1, 0.3 * uSteerConfigs.y, uSteerConfigs.y); // use uSteerConfigs.y for scaling
    a.minSpeed = a.DNA.b * uSteerConfigs.y * 0.3; // make sure minSpeed is less than maxSpeed
